...
// import child value
import { Child } from "../SP/HomeSP";
type ChildRouteProp = RouteProp<{ assessment: { child: Child } }, "assessment">;

// Define API URL
import { API_ASSESSMENT_CHILD_SUPERVISOR, API_ENDPOINT } from "@env";

export const ChildDetailSP: FC = () => {
  // useState
      ...
      const fetchChildDataForParent = async () => {
        try {
          ...
          const response = await fetch(
            `${API_ENDPOINT}/${API_ASSESSMENT_CHILD_SUPERVISOR}/${supervisor_id}/${child.child_id}`,
            {
              headers: {
  ...
  return (
    ...
    >
      ...
      <View style={styles.midSection}>
        ...
        >
          <Text style={styles.headerText}>ผลการประเมินล่าสุดของผู้ดูแล</Text>
        </LinearGradient>

...
// Define API URL
import { API_ASSESSMENT_CHILD_PARENT_FOR_SUPERVISOR, API_ENDPOINT } from "@env";

export const ChildDetailPRforSP: FC = () => {
  // useState
  ...
  useFocusEffect(
    useCallback(() => {
      ...
      const fetchChildDataPRForSP = async () => {
        try {
          ...
          const response = await fetch(
            `${API_ENDPOINT}/${API_ASSESSMENT_CHILD_PARENT_FOR_SUPERVISOR}/${child.child_id}`,
            {
              headers: {
          ...
          <View style={styles.midSection}>
            ...
            >
              <Text style={styles.headerText}>
                ผลการประเมินล่าสุดของผู้ปกครอง
              </Text>
            </LinearGradient>
